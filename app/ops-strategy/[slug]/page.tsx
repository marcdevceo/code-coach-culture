...
export async function generateStaticParams() {
  const categoryDir = path.join(process.cwd(), 'content', 'ops-strategy');
...
export default async function Page({
  ...
  try {
    ...
    return (
      <article className="min-h-screen bg-gradient-to-br from-blue-200 to-blue-400 text-gray-800 p-6 font-sans ">
        <div className="mt-5 mb-10">
        <BackLink      
          href="/ops-strategy"
          blog_category="Ops & Strategy"
        />
        </div>
